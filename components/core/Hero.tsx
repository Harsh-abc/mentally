    ...
    <>
      <section className="relative h-[50%]">
        ...
        <div className="w-full relative top-10 left-[68%]">
          ...
          <Button
            className={"bg-(--cta-button) py-5 rounded-full mt-10 absolute z-99"}
          >
            <CTA
        ...
        <div className="absolute -top-10 left-[50%] transform translate-x-[-50%] w-180">
          ...
          <div className="absolute top-2 left-3 w-full  opacity-[0.4]">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="100%"
        ...
        <div className="relative h-screen">
          ...
          <div className="absolute top-115 flex items-center justify-center">
            <p className="text-6xl w-[60%] font-semibold text-white font-crimson">
              Where curiosity replaces judgment, and healing happens in
              connection.
            </p>
          </div>
        </div>
