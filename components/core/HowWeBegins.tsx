...
export default function HowWeBegins() {
    return (
        <section className="px-20 py-24 relative overflow-hidden h-screen">
            <div>
                <h2 className="text-6xl font-semibold font-heading  mt-4 leading-tight tracking-wide uppercase">How we <span className="font-light text-bronze">begin together</span></h2>
            </div>
